...
public class AdminCreator {
     ...
     */
    public static boolean ajouterAdmin(com.projet.jee.model.Administrateur admin) {
    ...
    public static void main(String[] args) {
        com.projet.jee.model.Administrateur admin = new com.projet.jee.model.Administrateur(
                3,
                "Admi3",
                "Principal",
                "admin3@gmail.com",
