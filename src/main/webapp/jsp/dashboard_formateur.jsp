...
<body>
    ...
    <aside class="sidebar">
        ...
        <div class="nav-section">
            ...
            <ul class="nav-links">
                <li><a href="<%= request.getContextPath() %>/dashboardFormateur" class="nav-link active">
                    <i class="fas fa-chart-pie"></i><span>Tableau de bord</span></a></li>
                <li><a href="#" class="nav-link"><i class="fas fa-user-graduate"></i><span>Mes candidats</span></a></li>
                <li><a href="#" class="nav-link"><i class="fas fa-calendar-check"></i><span>Mes entretiens</span></a></li>
                <li><a href="#" class="nav-link"><i class="fas fa-book"></i><span>Mes modules</span></a></li>
            </ul>
        </div>
        <div class="nav-section">
            <h3 class="nav-title">Outils</h3>
            <ul class="nav-links">
                <li><a href="#" class="nav-link"><i class="fas fa-envelope"></i><span>Messagerie</span></a></li>
                <li><a href="#" class="nav-link"><i class="fas fa-cog"></i><span>Paramètres</span></a></li>
            </ul>
        </div>
        <div class="nav-section" style="margin-top: auto;">
            <ul class="nav-links">
                <li><a href="<%= request.getContextPath() %>/LogoutServlet" class="nav-link">
                    <i class="fas fa-sign-out-alt"></i><span>Déconnexion</span></a></li>
            </ul>
        </div>
    </aside>
